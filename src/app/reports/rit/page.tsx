    ...
    <div className="pt-40 flex flex-col justify-left items-center lg:pt-26">
      ...
      <form className="flex flex-col items-left w-3/4">
          ...
          <section>
            ...
            <TextAreaInput label={"Listar disciplinas ministradas, orientações de alunos concluídas no decorrer do semestre ou em andamento, horários disponibilizados para o atendimento ao aluno, e demais atividades de ensino descritas no Plano de Trabalho Docente."} id={"teaching-activities"} />
          </section>
          
          <section>
            <SectionHeader title="ATIVIDADES DE PESQUISA APLICADA"/>
            <TextAreaInput label={"Relatar o andamento dos projetos e demais atividades de pesquisa aplicada listadas no Plano de Trabalho Docente. No caso de projetos, indicar o cronograma de execução (prazos atuais) e as atividades desenvolvidas no decorrer do semestre.."} id={"applied-research-activities"} />
          </section>
          
          <section>
            <SectionHeader title="ATIVIDADES DE EXTENSÃO"/>
            <TextAreaInput label={"Relatar o andamento dos projetos e demais atividades de extensão listadas no Plano de Trabalho Docente. No caso de projetos ou programas, indicar o cronograma de execução (prazos atuais) e as atividades desenvolvidas no decorrer do semestre."} id={"outreach-activities"} />
          </section>
          
          <section>
            <SectionHeader title="ATIVIDADES DE GESTÃO"/>
            <TextAreaInput label={"Descrever as principais atividades desenvolvidas na gestão institucional do IFCE de acordo com a função; ou atividades em comissões/fiscalizações realizadas no decorrer do semestre de acordo com o Plano de Trabalho Docente."} id={"management-activities"} />
          </section>
